...
// FFCTemplate
#define COCOAPODS_POD_AVAILABLE_FFCTemplate
#define COCOAPODS_VERSION_MAJOR_FFCTemplate 0
#define COCOAPODS_VERSION_MINOR_FFCTemplate 1
#define COCOAPODS_VERSION_PATCH_FFCTemplate 0
